...
interface SynthesisDepartmentProps {
  subDepartmentId: string | null;
}

const SynthesisDepartment: React.FC<SynthesisDepartmentProps> = ({ subDepartmentId }) => {
  const [showGoalPlan, setShowGoalPlan] = useState(false);
  const departmentName = "Bộ phận tổng hợp";
  
  // Find the current sub-department name if applicable
  let subDepartmentName = "";
  if (subDepartmentId === 'synthesis-quote') subDepartmentName = "Tính báo giá";
  if (subDepartmentId === 'synthesis-partners') subDepartmentName = "Đối tác";
      ...
      {!subDepartmentId ? (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            <div className="bg-white p-3 md:p-4 rounded-lg shadow border border-gray-200">
              <h3 className="font-medium text-base md:text-lg mb-2">Tính báo giá</h3>
              <p className="text-sm text-gray-600 mb-2 md:mb-3">Quản lý thông tin và hoạt động tính báo giá</p>
            ...
            <div className="bg-white p-3 md:p-4 rounded-lg shadow border border-gray-200">
              <h3 className="font-medium text-base md:text-lg mb-2">Đối tác</h3>
              <p className="text-sm text-gray-600 mb-2 md:mb-3">Quản lý thông tin và hoạt động với đối tác</p>
              <div className="text-right">
                <button className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                  Xem chi tiết
                </button>
...
export default SynthesisDepartment;
